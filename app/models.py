...
class BorrowedBook(Base):
    ...
    borrow_date: Mapped[datetime.datetime | None] = mapped_column(default=func.now(), nullable=False)
    return_date: Mapped[datetime.datetime | None] = mapped_column(nullable=True)
