...
Revision ID: e2615d975559
Revises:
Create Date: 2025-05-27 11:31:45.155376
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("copies >= 0", name="check_copies_positive"),
    ...
    op.create_index(
        op.f("ix_borrowed_books_id"), "borrowed_books", ["id"], unique=False
    )
